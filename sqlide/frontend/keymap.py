...
ACTIONS: tuple[Action, ...] = (
    ...
    Action("win.new-mcp", "New MCP server window", "Tabs", "<primary><alt>m", "win"),
    Action("win.history", "Open history", "Tabs", "<primary><shift>h", "win"),
    Action("win.backups", "Open the backup manager", "Tabs", "", "win"),
    Action("win.refresh-schema", "Refresh schema", "Tabs", "F5", "win"),
    Action("win.split-view", "Toggle split view", "Tabs", "<primary><alt>s", "win"),
